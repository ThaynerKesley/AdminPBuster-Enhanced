...
PATHS_URL = "https://raw.githubusercontent.com/blackhatethicalhacking/AdminPanelFetcher/refs/heads/main/magic_admin_paths.txt"
...
def print_toilet_banner_lolcat():
    ...
    os.system("toilet -f smblock 'AdminPanelFetcher' | lolcat")
...
def print_rainbow_banner():
    os.system("clear")
    print("\n" + rainbow_text("Admin Panel Fetcher"))
    print(colored(f"\nVersion: {VERSION}", "yellow"))
    print(colored(f"Author: {AUTHOR}", "yellow"))
...
def admin_panel_fetcher(target_domain, threads, random_ua):
...
if __name__ == "__main__":
    ...
    countdown()
    admin_panel_fetcher(ARGS.target, ARGS.threads, ARGS.random_agent)
